...
if(isset($_GET['update_id'])){  //เมื่อรับค่า update_id
    $update_id=$_GET['update_id'];
     $sql= "SELECT * 
            FROM position
            WHERE positionId ='".$update_id."'";
    $result = mysqli_query($conn,$sql);   // run คำสั่ง sqli
    while($array1 = mysqli_fetch_array($result)){   //แสดงผล
?>
<!DOCTYPE html>
<html>
  <head>
    ...
    <title>แก้ไขข้อมูลตำแหน่งที่จอดรถ</title>
  ...
  <body>
    ...
    <div class="page">
      ...
      <form method="post" action="position_update.php" enctype="multipart/form-data">
        <center>
        <br><br>
            <font face="TH Sarabun New" size="8"><b>แก้ไขข้อมูลตำแหน่งที่จอดรถ</b></font>
            <font face="TH Sarabun New" size="5"><b>
            <table border="0">
        <tr>
            <td align="right">รหัสตำแหน่ง : </td>
            <td><input type="text" class="form-control" name="positionId" value="<?php echo $array1['positionId']?>" readonly></td>
        </tr>
        <tr>
            <td align="right">ตึก : </td>
            <td><input type="text" class="form-control" name="building" value="<?php echo $array1['building']?>" readonly></td>
        </tr>
        <tr>
            <td align="right">ชั้น : </td>
            <td><input type="text" class="form-control" name="floor" value="<?php echo $array1['floor']?>"></td>
        </tr>
        <tr>
            <td align="right">เลขช่องที่จอดตึก A : </td>
            <td><input type="text" class="form-control" name="positionA" value="<?php echo $array1['positionA']?>"></td>
        </tr>
        <tr>
            <td align="right">เลขช่องที่จอดตึก B : </td>
            <td><input type="text" class="form-control" name="positionB" value="<?php echo $array1['positionB']?>"></td>
        </tr>
        <tr>
            <td></td>
