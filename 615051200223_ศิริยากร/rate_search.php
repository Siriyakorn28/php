...
<html>
  <head>
    ...
    <title>ค้นหาข้อมูลอัตราค่าจอดรถ</title>
  ...
  <body>
    ...
    <div class="page">
      ...
      <form method="post" action="rate_search.php" enctype="multipart/form-data">
    <br><br>
    <center>
        <font face="TH Sarabun New" size="10"><b>ค้นหาข้อมูลอัตราค่าจอดรถ</b></font>
        ...
        <table border="0">
            <tr>
                ...
                <td><select class="form-control" name="list">
                        ...
                        <option value="choose">จอดแบบ</option>
                    </select></td>
                <td><input class="form-control mr-sm-2" type="text" name="keyword" placeholder="ค้นหา"> 
                </td>
...
<br>
  ...
  require_once('connect.php');   //เชื่อมต่อฐานข้อมูล
      ...
      if($select == 'all'){   //ถ้าเลือก all จะแสดงข้อมูลของตาราง rate ทั้งหมด
          $sql = "SELECT *
                  FROM rate";
  ...
  <table width="800" border="1">
      <tr>
          <td align="center"><b>รหัสอัตราค่าจอดรถ</b></td>
          <td align="center"><b>จอดแบบ</b></td>
          <td align="center"><b>ราคาอัตราค่าจอด</b></td>
          <td align="center"><b>จำนวนอัตราที่จอด</b></td>
  ...
  ?>
      <tr>
          <td align="center"><?=$array["rateId"];?></td>
          <td align="center"><?=$array["choose"];?></td>
          <td align="center"><?=$array["rate"];?></td>
          <td align="center"><?=$array["amount"];?></td>
          <td align="center"><?=$array["price"];?></td>
          <td align="center"><a href="rate_update.php?update_id=<?php 
              echo $array["rateId"];?>">แก้ไข</a></td>
          <td align="center"><a href="rate_delete.php?delete_id=<?php 
              echo $array["rateId"];?>">ลบ</a></td>
      </tr>
