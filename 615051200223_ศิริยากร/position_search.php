...
<html>
  <head>
    ...
    <title>ค้นหาข้อมูลตำแหน่งที่จอดรถ</title>
  ...
  <body>
    ...
    <div class="page">
      ...
      <form method="post" action="position_search.php" enctype="multipart/form-data">
    <br><br>
    <center>
        <font face="TH Sarabun New" size="10"><b>ค้นหาข้อมูลตำแหน่งที่จอดรถ</b></font>
        ...
        <table border="0">
            <tr>
                ...
                <td><select class="form-control" name="list">
                        ...
                        <option value="positionId">รหัสตำแหน่งที่จอดรถ</option>
                        <option value="building">ตึก</option>
                        <option value="floor">ชั้น</option>
                    </select></td>
                <td><input class="form-control mr-sm-2" type="text" name="keyword" placeholder="ค้นหา" autocomplete="off" > 
                </td>
...
require_once('connect.php');
    ...
    //ถ้าเลือก all จะแสดงข้อมูลของตาราง position ทั้งหมด
    if($select == 'all'){
        $sql = "SELECT *
                FROM position";
...
<table width="800" border="1">
    <tr>
        <td align="center"><b>รหัสตำแหน่งที่จอดรถ</b></td>
        <td align="center" width="100"><b>ตึก</b></td>
        <td align="center" width="100"><b>ชั้น</b></td>
        <td align="center"><b>เลขช่องที่จอกตึก A</b></td>
        <td align="center"><b>เลขช่องที่จอกตึก B</b></td>
...
?>
    <tr>
        <td align="center"><?=$array["positionId"];?></td>
        <td align="center"><?=$array["building"];?></td>
        <td align="center"><?=$array["floor"];?></td>
        <td align="center"><?=$array["positionA"];?></td>
        <td align="center"><?=$array["positionB"];?></td>
        <td align="center"><a href="position_update.php?update_id=<?php 
            echo $array["positionId"];?>">แก้ไข</a></td>
        <td align="center"><a href="position_delete.php?delete_id=<?php 
            echo $array["positionId"];?>">ลบ</a></td>
    </tr>
